# v6 - abstract <sep> title <sep> full_text [order preservation random selection]
...
def process_data(file, path):
    ...
    for i in range(len(data)):
        ...
        src_len            = sum([len(element) + 1 for element in sentences]) + len(src[:indices[1]])
...
dump_folder = '../stage2_processed_data/v6/'
